...
class Assets:
    GITHUB_RELEASE_API = "https://api.github.com/repos/Quocnd1704/Yolo-Hcaptcha/releases"
...
class PluggableObjects:
    URL_REMOTE_OBJECTS = (
        "https://raw.githubusercontent.com/Quocnd1704/Yolo-Hcaptcha/main/src/objects.yaml"
    )
